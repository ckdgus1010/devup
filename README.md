...
| **v1.1** | - AI 기능 추가(면접 답변 평가, 추천 등)  <br>- 북마크<br>  |
| **v1.2** | - 관리자 기능 추가(질문 관리, 사용자 관리 등)               |
...
| **Infra**    | `AWS EC2`, `IntelliJ`, `Gradle`, `GitHub`              |
...
# DB
DB_URL=jdbc:mariadb://localhost:3306/database_name
DB_USERNAME=username
DB_PASSWORD=password

# OpenAI
SPRING_OPEN_AI_API_KEY=openai_api_key
```
...
| 🏠 홈 화면                                                           | 📂 문제 목록 화면                                                                    |
|-------------------------------------------------------------------|--------------------------------------------------------------------------------|
| <img src="./docs/readme/img/home.png" alt="홈 화면" width="478.5px"> | <img src="./docs/readme/img/question-list.png" alt="문제 목록 화면" width="478.5px"> |

| 🧩 면접 질문 풀이 화면                                                                   | ✅ AI 정답 판단 결과 화면                                                                       |
|----------------------------------------------------------------------------------|----------------------------------------------------------------------------------------|
| <img src="./docs/readme/img/question-detail.png" alt="문제 풀이 화면" width="478.5px"> | <img src="./docs/readme/img/ai-answer-check.png" alt="AI 정답 판단 결과 화면" width="478.5px"> |
...
└── src/
    └── main/
        ...
        │       ├── question/   # 면접 질문 기능
        │       ├── user/       # 사용자 관련 기능(마이페이지, 통계, 오답노트 등)
        └── resources/
            ├── ai              # AI 관련 설정 파일
